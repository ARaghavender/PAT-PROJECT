...
if($res = $conn->query($sql)){
    if($res->num_rows > 0){
        ...
        echo "<form method='POST' action='main.html' style='display:none'><input type='text' name='username' value='$name'> <input type='submit' id='submit'></form>";
        $result="true";
        ...
        $result="false";
        echo "<script>setTimeout(function(){ location.href='index.html'; }, 1000);</script>";
    }
} else{
